...
## Profesores
- Apellido y nombre: Hoyos Oscar, Serrano Manuel.

## Definición del problema
Actualmente el registro de pacientes se registra de forma manual, este método operativo genera una fragmentación de la información y un alto riesgo de errores críticos. La transcripción manual facilita la confusión de datos o la pérdida de fichas al traspapelarse. Por otro lado, el uso de documentos de texto para los resultados provoca una proliferación de versiones de un mismo archivo, lo que dificulta la búsqueda, organización y trazabilidad de los antecedentes médicos de los pacientes.
