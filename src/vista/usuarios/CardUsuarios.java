...
public class CardUsuarios extends javax.swing.JPanel {
    ...
    /**
     * Carga los números de las 3 tarjetas (jLabel9/jLabel8/jLabel7, debajo de "Total de
     * Usuarios"/"Administradores"/"Tecnicos"): el Form Editor las deja vacías, ver
     * {@link vistas.formulariosPrincipales.Usuarios}.
     */
    public void setTotales(int total, int administradores, int tecnicos) {
        jLabel9.setText(String.valueOf(total));
        jLabel8.setText(String.valueOf(administradores));
        jLabel7.setText(String.valueOf(tecnicos));
    }
