...
import vistas.escritorio.Card;
import javax.swing.Icon;

/**
 * POJO de soporte para poblar un {@link Card}: agrupa el icono, título, valor destacado y
 * descripción que se le van a asignar a la tarjeta, para poder armarlos y pasarlos juntos (ej.
 * al construir el conjunto de tarjetas del dashboard) en vez de llamar a los setters de {@link
 * Card} uno por uno.
 */
