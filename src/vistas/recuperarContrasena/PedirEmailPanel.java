...
/**
 * Pantalla "Recuperar contraseña": primer paso del flujo, donde se pide el email de la cuenta
 * antes de mandar el código de verificación.
 * Igual que {@link RecuperarContrasenaFrame}, se escribió a mano y no tiene un {@code .form}
 * propio.
 */
public class PedirEmailPanel extends javax.swing.JPanel {
    ...
    /**
     * Validación de formato básica, solo para dar una respuesta inmediata ante un typo evidente
    ...
    /**
     * Se dispara cuando el usuario hace click en "Regresar al login", sin llegar a pedir ningún
     * código.
     */
    ...
    /**
     * Campo de texto para el email de esta tarjeta: contorno redondeado (sin relleno, a diferencia
     * de {@link interfaz.JTextFieldRedondeado}) con un sobre dibujado a mano a la izquierda y
     * placeholder propio.
     */
