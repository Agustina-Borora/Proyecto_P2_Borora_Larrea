...
package vistas.recuperarContrasena;

/**
 * Pantalla "Token de Confirmación": ingreso del código de 6 dígitos enviado por correo
 * electrónico.
 *
 * @author agust
 */
public class TokenDeConfirmacion extends javax.swing.JPanel {
    ...
    /**
     * Se dispara cuando el usuario completa los 6 dígitos y hace click en "Verificar Codigo".
     */
    ...
    /**
     * Asigna un placeholder corto a cada casilla del código.
     */
    ...
    /**
     * Ajusta el padding interno y la alineación de las seis casillas del código, heredados de
     * {@link interfaz.JTextFieldRedondeado} sin adaptarlos a este nuevo ancho.
     */
    ...
    /**
     * Le pone a cada casilla del código un {@link javax.swing.text.DocumentFilter} que solo deja
     * escribir un dígito numérico (nada de letras, símbolos ni más de un carácter), que pasa el
     * foco a la siguiente casilla apenas se completa una, y que vuelve a la anterior cuando se
     * borra el dígito con Backspace/Delete — así se puede cargar y corregir el código corrido, sin
     * tocar el mouse ni el Tab.
     * El filtro de documento por sí solo no alcanza para una casilla que YA está vacía: ahí
     * Backspace no dispara ningún cambio en el documento (no hay nada que borrar), así que además
     * se engancha un {@link java.awt.event.KeyListener} en cada casilla para ese caso puntual:
     * Backspace sobre una casilla vacía pasa el foco para atrás igual, sin que haga falta mover el
     * cursor a mano primero.
     */
    ...
    /**
     * Filtro de documento para una casilla de código: descarta cualquier carácter que no sea un
     * dígito (0-9), deja como máximo un dígito cargado a la vez (si ya había uno, el nuevo lo
     * reemplaza), pasa el foco a la casilla siguiente al completarse, y a la anterior cuando el
