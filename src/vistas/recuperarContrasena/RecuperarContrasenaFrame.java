 ...
 * código de verificación, lo valida en {@link TokenDeConfirmacion} y finalmente deja elegir
 * una contraseña nueva en {@link CambiarContraseña}.
 * A propósito NO tiene un .form propio: en vez de diseñar una pantalla nueva en el editor
 * visual de NetBeans (con el riesgo de corromper el .form si el editor no resuelve bien algún
 * componente custom), reutiliza los tres paneles ya diseñados con el mismo estilo del proyecto
 * (PedirEmailPanel, TokenDeConfirmacion, CambiarContraseña) montados sobre un CardLayout.
 */
public class RecuperarContrasenaFrame extends javax.swing.JFrame {
    ...
    /**
     * PedirEmailPanel es una tarjeta chica y autocontenida (ver su Javadoc), a diferencia de
     * TokenDeConfirmacion/CambiarContraseña que están pensadas para el tamaño grande de Login.
     */
    ...
    /**
     * Arma la ventana con las tres pantallas del flujo y la deja mostrando la de pedir el email.
     */
    ...
    /**
     * Cambia de carta en el CardLayout y, ya que no todas las pantallas del flujo miden lo mismo,
     * redimensiona y recentra la ventana acorde a la carta nueva.
     */
    ...
    /**
     * Callback de {@link PedirEmailPanel.EmailIngresadoListener}: le pide a PasswordController que
     * genere y mande el código.
     */
    private void onEmailIngresado(String email) {
        controlador.PasswordController.ResultadoSolicitud resultado =
                controlador.PasswordController.solicitarCodigo(this, email);
