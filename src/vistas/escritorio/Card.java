 ...
 * valor destacado y descripción.
 * <p> El fondo se dibuja a mano en {@link #paintComponent(Graphics)} como un degradado ({@link
 * GradientPaint}) entre {@link #color1} y {@link #color2}, con esquinas redondeadas, por eso
 * el panel se crea no opaco (ver constructor).
 */
public class Card extends javax.swing.JPanel {
    ...
    /**
     * Modifica el color del texto de todas las etiquetas del componente (Título, Valor y
     * Descripción).
     *
...
/**
 * Pinta el fondo de la tarjeta como un degradado (de {@link #color1} a {@link #color2}) con
 * bordes redondeados, antes de delegar en {@code super.paintComponent} para que Swing dibuje
 * encima el icono y los textos.
 */
    @Override
