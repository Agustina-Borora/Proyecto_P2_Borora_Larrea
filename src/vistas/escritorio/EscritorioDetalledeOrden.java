...
import vistas.catalogoExamenes.TablaCatalogoExamenes;
 ...
 * una orden puntual, junto con los resultados a cargar.
 * Los componentes (título, secciones "Paciente" y "Analisis", badges de cabecera, tabla y
 * botones) fueron ubicados mediante el editor visual de NetBeans con posicionamiento absoluto;
 * el método {@code initComponents()} generado por dicho editor se mantiene sin modificaciones.
 *
 * @author agust
 */
public class EscritorioDetalledeOrden extends javax.swing.JPanel {
    ...
    /**
     * Valores de muestra para los badges de cabecera.
     */
    ...
    /**
     * Da formato de "badge" (etiqueta con fondo de color y esquinas redondeadas) a los dos
     * indicadores de la cabecera: el estado de la orden y su tipo de cobertura.
     */
    ...
    /**
     * Aplica el estilo de badge a una etiqueta puntual: texto centrado, fondo de color y esquinas
     * redondeadas.
     *
    ...
    /**
     * Armoniza la apariencia de la tabla de exámenes con el resto del sistema (ver {@link
     * TablaCatalogoExamenes}): sin líneas de grilla, encabezado resaltado y selección en verde
     * suave.
     */
    ...
    /**
     * Da estilo a los botones de acción: "Cargar Resultados" como acción principal (verde,
     * relleno) y "Cerrar" como acción secundaria (borde suave, fondo blanco).
     */
