...
/**
 * Callback que implementa cada pantalla (TablaPacientes, etc.) para decidir qué pasa cuando se
 * aprieta cada uno de los botones de una fila.
 */
public interface TableActionEvent {
    ...
    /**
     * Se dispara al presionar el botón compartir de la fila indicada.
     */
