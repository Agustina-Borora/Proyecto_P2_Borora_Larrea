...
import vistas.nuevoAnalisis.*;

/**
 * Encabezado de solo lectura con los datos del paciente y de la orden que se muestra arriba de
 * la pantalla de carga de resultados (cargarReultados lo usa como sub-componente, embebido vía
 * el Form Editor).
 */
public class EncabezadoDatosPaciente extends javax.swing.JPanel {
    ...
    /**
     * Llena el encabezado con los datos de un paciente ya existente (lo usa Registrar Resultados
     * al pasar a esta pantalla, con la orden ya elegida de la lista).
     *
