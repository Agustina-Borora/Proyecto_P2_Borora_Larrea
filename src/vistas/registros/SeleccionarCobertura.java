...
/**
 * Contenido del diálogo modal chico que arma FiltrosBusqueda para elegir la cobertura a
 * filtrar (Particular / Obra Social / Mixto, con checkboxes de selección múltiple).
 */
public class SeleccionarCobertura extends javax.swing.JPanel {
    ...
    /**
     * Valida que haya al menos una cobertura tildada, arma el texto del filtro ("Todas las
     * coberturas" si están las 3, o las tildadas unidas por coma), se lo pasa a {@link
     * FiltrosBusqueda#setCoberturaFiltro(String)} y cierra el modal.
     */
