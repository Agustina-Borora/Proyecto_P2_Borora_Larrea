...
/**
 * Contenido del diálogo modal chico que arma FiltrosBusqueda para elegir el estado a filtrar
 * (Pendiente / En Proceso / Completado - Sin enviar / Completado - Enviado, con checkboxes de
 * selección múltiple).
 */
public class SeleccionarEstado extends javax.swing.JPanel {
    ...
    /**
     * Arma el panel y le da a los botones Guardar/Cancelar el estilo verde de FlatLaf.
     */
    ...
    /**
     * Valida que haya al menos un estado tildado, arma el texto del filtro ("Todos los estados" si
     * están los 4, "N seleccionados" si hay más de uno, o el nombre del único tildado) y se lo
     * pasa a {@link FiltrosBusqueda#setEstadoFiltro(String)}, y cierra el modal.
     */
