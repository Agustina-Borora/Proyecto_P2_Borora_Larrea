...
/**
 * Contenido del diálogo modal chico que arma FiltrosBusqueda para elegir un rango de fechas
 * ("desde" / "hasta") como filtro, mediante dos {@link com.toedter.calendar.JDateChooser}.
 */
public class SeleccionarFecha extends javax.swing.JPanel {
    ...
    /**
     * Arma el panel, bloquea la escritura manual en ambos selectores de fecha (solo se puede
     * elegir con el calendario desplegable, para evitar fechas mal tipeadas) y le da a los botones
     * Guardar/Cancelar el estilo verde de FlatLaf.
     */
    ...
    /**
     * Constructor real, usado por FiltrosBusqueda al responder al click sobre el rótulo o el
     * mini-panel de "Rango de Fecha".
     *
    ...
    /**
     * Valida que ambas fechas estén completas y que "desde" no sea posterior a "hasta", formatea
     * el rango como texto (dd/MM/yyyy) y se lo pasa a {@link
     * FiltrosBusqueda#setFechaFiltro(String)}, y cierra el modal.
     */
