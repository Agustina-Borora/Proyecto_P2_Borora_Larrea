...
public class TipoCobertura extends javax.swing.JPanel {
    ...
    /**
     * Prepara el panel: aplica el estilo visual del contenedor, registra el click de las tres
     * tarjetas de cobertura (tarjeta y sus etiquetas hijas, para que un click sobre el texto
     * también cuente) y deja "Particular" seleccionada por defecto.
     */
...
private final java.util.Map<String, vistas.panels.PanelBorder> tarjetasCobertura = new java.util.LinkedHashMap<>();
private String coberturaSeleccionada;

/**
 * Se avisa cada vez que cambia la tarjeta elegida, para que Solicitud de Análisis actualice la
 * columna "Obra Social".
 */
 ...
 * resaltarla/des-resaltarla despues) y engancha el mismo click tanto en el panel como en sus
 * etiquetas hijas, porque un click sobre el texto lo recibe el JLabel y nunca llega al panel
 * contenedor.
 */
private void registrarSeleccion(vistas.panels.PanelBorder tarjeta, String clave, javax.swing.JComponent... hijos) {
...
public void seleccionarCobertura(String clave) {
    ...
    for (java.util.Map.Entry<String, vistas.panels.PanelBorder> entrada : tarjetasCobertura.entrySet()) {
        boolean esElegida = entrada.getKey().equals(clave);
        vistas.panels.PanelBorder tarjeta = entrada.getValue();
...
public String getCoberturaSeleccionada() {
    ...
    private void initComponents() {
        ...
        panelBorder3 = new vistas.panels.PanelBorder();
    ...
    private vistas.panels.PanelBorder panelBorder3;
