...
/**
 * Componente de buscador reutilizable: un campo de texto con ícono/estilo de búsqueda que se
 * embebe en las pantallas de Pacientes, Registros y Registrar Resultados.
 */
public class Busqueda extends javax.swing.JPanel {

    /**
     * Se dispara cada vez que cambia el texto del buscador (a medida que se escribe) o al
     * presionar Enter, para que la pantalla que contiene este panel (Pacientes, Registros, etc.)
     * filtre su tabla.
     */
    ...
    /**
     * Arma el panel, aplica el estilo visual del campo de búsqueda y deja instalado el filtro
     * {@link FiltroLetraONumero} más el listener que dispara {@link #avisarBusqueda()} en cada
     * cambio de texto.
     */
 public Busqueda() {
        initComponents();
    ...
    /**
     * Registra un listener que va a recibir el texto de búsqueda cada vez que cambie.
     */
    ...
    /**
     * Notifica a todos los listeners registrados el texto actual del campo de búsqueda.
     */
    ...
    /**
     * Da estilo FlatLaf al campo de texto: bordes redondeados, color de foco verde corporativo,
     * texto de ayuda "Buscar..." y botón de limpiar (X).
     */
    ...
    /**
     * Al presionar Enter en el campo, dispara la búsqueda inmediatamente (además del aviso que ya
     * ocurre en cada tecleo por el DocumentListener).
     */
