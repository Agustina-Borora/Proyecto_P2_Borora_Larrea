...
/**
 * Menú lateral (sidebar) de navegación de toda la aplicación.
 */
public class Menu extends javax.swing.JPanel {

    /**
     * Arma el panel, deja transparente el fondo (para que se vean las esquinas redondeadas
     * pintadas en {@link #paintChildren}) y carga las opciones del menú.
     */
    public Menu() {
        initComponents();
    ...
    /**
     * Registra el listener que va a recibir el id de la opción elegida por el usuario (ver {@link
     * EventMenuSelected}); lo usa Principal para decidir qué pantalla mostrar.
     */
    ...
    /**
     * Carga en {@code listMenu1} las secciones fijas del menú (con sus ids, títulos de grupo y
     * separadores) y deja "Escritorio" seleccionado por defecto al arrancar la aplicación.
     */
    private void init() {
        listMenu1.addItem(new Model_Menu("", " ", Model_Menu.MenuType.EMPTY));
        listMenu1.addItem(new Model_Menu("", "Principal", Model_Menu.MenuType.TITLE));
        listMenu1.addItem(new Model_Menu("", " ", Model_Menu.MenuType.EMPTY));
        listMenu1.addItem(new Model_Menu("4_1", "escritorio", "Escritorio", Model_Menu.MenuType.MENU));
        listMenu1.addItem(new Model_Menu("5_1", "pacientes", "Pacientes", Model_Menu.MenuType.MENU));
        listMenu1.addItem(new Model_Menu("2", "registros", "Registros", Model_Menu.MenuType.MENU));
        listMenu1.addItem(new Model_Menu("", " ", Model_Menu.MenuType.EMPTY));
    ...
    private void initComponents() {
        ...
        listMenu1 = new vistas.menu.ListMenu<>();
 ...
 */
    ...
    private vistas.menu.ListMenu<String> listMenu1;
