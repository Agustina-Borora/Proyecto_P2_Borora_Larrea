...
/**
 * Filtro para campos numéricos con tope de longitud (Celular, DNI): solo deja escribir
 * dígitos, y no deja pasar de largoMaximo caracteres en total (contando lo que ya hay en el
 * campo).
 */
public class FiltroSoloDigitos extends DocumentFilter {
    ...
    /**
     * Descarta todo lo que no sea dígito de {@code string} y, si el campo ya alcanzó (o superaría)
     * {@code largoMaximo}, recorta lo que se puede insertar para no pasarse del tope; si no queda
     * espacio disponible, simplemente aplica el borrado del tramo seleccionado sin insertar nada.
     */
