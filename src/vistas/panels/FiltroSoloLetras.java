...
/**
 * Filtro para campos de nombre de persona (Apellido y Nombre, Medico Derivante): solo letras
 * (con acentos), espacios, apóstrofe y guion -- para poder escribir "O'Connor" o
 * "Pérez-García".
 */
public class FiltroSoloLetras extends DocumentFilter {
    ...
    /**
     * Devuelve {@code string} quedándose solo con letras, espacio, apóstrofe y guion; el resto de
     * los caracteres se descarta.
     */
