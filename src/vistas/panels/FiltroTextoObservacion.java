...
/**
 * Filtro para texto libre corto con puntuación básica (Observación): letras, números, espacios
 * y la puntuación habitual de una nota clínica breve (.
 */
public class FiltroTextoObservacion extends DocumentFilter {
    ...
    /**
     * Devuelve {@code string} quedándose con letras, dígitos, espacio y la puntuación de {@link
     * #PUNTUACION_PERMITIDA}; descarta cualquier otro símbolo (arrobas, signos de moneda, etc.).
     */
