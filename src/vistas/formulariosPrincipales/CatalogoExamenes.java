 ...
 * Los componentes de esta pantalla (título, subtítulo, barra de búsqueda, botón y tabla)
 * fueron ubicados mediante el editor visual de NetBeans; el método {@code initComponents()}
 * generado por dicho editor se mantiene sin modificaciones.
 *
 * @author agust
 */
public class CatalogoExamenes extends javax.swing.JPanel {
    ...
    /**
     * Textos de la fila de filtro mientras no esté conectada a la base de datos.
     */
    ...
    /**
     * Aplica el estilo visual (tipografía, colores y bordes) a los componentes generados por el
    ...
    /**
     * Estiliza el botón "+ Nuevo Examen".
     */
    ...
    /**
     * Estiliza la fila de filtro (etiqueta descriptiva, contador y combo de categorías).
     */
    ...
    private void initComponents() {
        ...
        tablaCatalogoExamenes1 = new vistas.catalogoExamenes.TablaCatalogoExamenes();
    ...
    private vistas.catalogoExamenes.TablaCatalogoExamenes tablaCatalogoExamenes1;
